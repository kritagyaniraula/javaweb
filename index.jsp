...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">My Developer</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<li class="nav-item mx-0 mx-lg-1"><a href="update.jsp" class="signup-image-link">Change Profile</a></li>
					...
					<li class="nav-item mx-0 mx-lg-1 bg-danger"  ><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="Logout">Logout</a><%= session.getAttribute("name") %></li>
